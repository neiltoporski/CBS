...
Future<void> igNode(BuildContext context, int numNodes) async {
  ...
  getNodeInfo() async {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        initChoices = List.generate(8, (i) => <String>[
                       doc.get('Option ${i+1}'),
                       doc.get('Score ${i+1}').toString(),
                       doc.get('Information ${i+1}'),
  ...
  List<List<TextEditingController>> choices = List.generate(8, (i) => List.generate(4, (j) => TextEditingController(text: initChoices[i][j])));
                  ...
                  children: [
                    Flexible(
                      child: ListView(
                        ...
                        children: <Widget>[
                          const Text('Information Gathering Node',
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              // IconButton for uploading audio
                              IconButton(
                                onPressed: () async {
                                            ...
                                            child: Focus(
                                              onFocusChange: (focus) {
                                                setState(() {
                                                  ...
                                                  for (int j = index; j < 7; j++) {
                                                    ...
                                                    if (([choices[j][0]]+choices[j].sublist(2)).every((controller) => controller.text.isEmpty) && choices[j][1].text == '0') {
                                                      // Check if there is a next row and it has data
                                                      if (([choices[j+1][0]]+choices[j+1].sublist(2)).any((controller) => controller.text.isNotEmpty) || choices[j+1][1].text != '0') {
                                              ...
                                              child: TextField(
                                                ...
                                                ? (choices[index-1][0].text.isNotEmpty
                                                    ...
                                                    || choices[index-1][3].text.isNotEmpty
                                                  )
                                                : true,
                                          ...
                                          child: FocusScope(
                                            child: Focus(
                                              ...
                                              child: TextField(
                                                ...
                                                controller: choices[index][2], //options,
                                              )
                                            )
                                          )
                                        ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            final newNode = <String, dynamic>{
                              ...
                              "Information 1": choices[0][2].text,
                              "Score 1": scores[0],
                              "Explanation 1": choices[0][3].text,
                              "Option 2": choices[1][0].text,
                              "Information 2": choices[1][2].text,
                              "Score 2": scores[1],
                              "Explanation 2": choices[1][3].text,
                              "Option 3": choices[2][0].text,
                              "Information 3": choices[2][2].text,
                              "Score 3": scores[2],
                              "Explanation 3": choices[2][3].text,
                              "Option 4": choices[3][0].text,
                              "Information 4": choices[3][2].text,
                              "Score 4": scores[3],
                              "Explanation 4": choices[3][3].text,
                              "Option 5": choices[4][0].text,
                              "Information 5": choices[4][2].text,
                              "Score 5": scores[4],
                              "Explanation 5": choices[4][3].text,
                              "Option 6": choices[5][0].text,
                              "Information 6": choices[5][2].text,
                              "Score 6": scores[5],
                              "Explanation 6": choices[5][3].text,
                              "Option 7": choices[6][0].text,
                              "Information 7": choices[6][2].text,
                              "Score 7": scores[6],
                              "Explanation 7": choices[6][3].text,
                              "Option 8": choices[7][0].text,
                              "Information 8": choices[7][2].text,
                              "Score 8": scores[7],
                              "Explanation 8": choices[7][3].text,
                              "imageUrl": imageUrl,
                              "videoUrl": videoUrl,
                              "audioUrl": audioUrl,
                            };
